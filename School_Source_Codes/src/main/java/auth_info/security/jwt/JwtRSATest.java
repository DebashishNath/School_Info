...
public class JwtRSATest {
    ...
    public void printStructure(String token, PublicKey publicKey) {
        ...
        Jws<Claims> parsedClaimsJws = jwtParser.parseClaimsJws(token);

        System.out.println("Header     : " + parsedClaimsJws.getHeader());
        System.out.println("Body       : " + parsedClaimsJws.getBody());
        System.out.println("Signature  : " + parsedClaimsJws.getSignature());
    }
